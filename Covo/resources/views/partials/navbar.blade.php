    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        ...
        <div class="mt-3">
            <ul>
                ...
                <li class="mb-1">
                    <a href="{{route('profile')}}">
                        <div class="flex lg:hidden justify-center items-center align-middle gap-2 border-2 w-fit   border-[#14BC9C] bg-green-50 rounded-full px-2 py-1">
                            <p class="text-[#334A5A] font-semibold align-middle text-sm ">{{auth()->user()->prenom }} {{auth()->user()->nom }}</p>
                            <img  src="{{ auth()->user()->photo ? asset('storage/'.auth()->user()->photo) : asset('image/user.jpg') }}" class="w-10 h-9 border border-[#14BC9C] rounded-full"  alt="user">
                        </div>
                         </a>
                ...
                <li class="mb-1">
                    <a class="block p-4 text-sm font-semibold text-[#334A5A] hover:bg-[#b1e6dc] hover:text-[#334A5A] rounded" href="{{route('convoiturage')}}">Convoiturage</a>
                </li>
                <li class="mb-1">
        ...
        <div class="mt-auto">
            @guest
            <div class="pt-6">
                <a class="block px-3 py-2 mb-2 leading-loose text-md  text-center text-white font-semibold ayoub hover:bg-left  rounded-xl" href="{{route('login')}}">Connexion <i class="bi bi-box-arrow-right"></i></a>
                <a class="block px-3 py-2 mb-2 leading-loose text-md  text-center text-white font-semibold safa hover:bg-left  rounded-xl" href="{{route('register')}}">Inscription <i class="bi bi-person-lines-fill"></i></a>
            </div>
            @endguest
            @auth
            <a class="block px-3 py-2 mb-2 leading-loose text-md  text-center text-white font-semibold safa hover:bg-left  rounded-xl" href="{{route('logout')}}">Déconnexion<i class="bi bi-person-lines-fill"></i></a>
            @endauth
