<x-layout>    
  ...
  <div class="min-h-screen w-full  bg-white s border-x-2 position-relative lg:w-8/12 ">
    ...
    <div class="flex justify-between px-2 m my-4 lg:justify-around lg:px-0">
             ...
             @endif
             @else
            <button id="add"  data-modal-target="default-modal1" data-modal-toggle="default-modal1" class="text-center text-sm lg:text-lg  text-[#334A5A] pt-1 iconChange hover:after:bg-[#14BC9C] hover:after:w-[100%] after:transition-all after:duration-300 after:m-auto after:h-[3px] after:w-0 after:block">Vérifier mon identité</button>
            @endif
