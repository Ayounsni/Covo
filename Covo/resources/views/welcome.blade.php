<x-layout>    
    <div class=" height image">
       ...
       <h1 class="display-4 fw-semibold  px-6 lg:w-6/12 mt-20 text-[#308284] titre1"> Covoiturez Pour <br>
        <span id="text-container" class="text-[#334A5A] display-2 fw-medium titre  ">  </span></h1>
        <div class="d-flex justify-content-center">
            <a href="" class=" px-7 border-2 border-[#334A5A] py-3 text-white transition-all duration-500 ayoub hover:bg-left lg:text-lg rounded-md text-gray-50 mt-4">Commencez Maintenant</a>
        </div>     
    </div>
    ...
    <div class=" heightt imagee mt-5 d-flex justify-content-evenly align-items-center  ">
       
            <div class="d-flex flex-column justify-content-center">
                 <p class="rounded-full p-9 bg-gray-100 transition-all duration-700 hover:bg-[#9be0d4]"><img width="85" height="85" src="https://img.icons8.com/external-justicon-lineal-color-justicon/64/external-route-map-and-location-justicon-lineal-color-justicon.png"
                     alt="external-route-map-and-location-justicon-lineal-color-justicon"/></p>
                 <p class="text-center text-green-100 fw-medium titre1 fs-3 mt-2">MEMBRES</p>
                 <p id="counter1" class="text-center display-3 fw-medium titre text-gray-50">0</p>
            </div>
            <div class="d-flex flex-column justify-content-center">
                <p class="rounded-full p-8 bg-gray-100 transition-all duration-700 hover:bg-[#9be0d4]"><img width="93" height="93" src="{{ asset('image/user.png') }}"
                    alt="external-route-map-and-location-justicon-lineal-color-justicon"/></p>
                <p class="text-center text-green-100 fw-medium titre1 fs-3 mt-2"> TRAJETS</p>
                <p id="counter2" class="text-center display-3 fw-medium titre text-gray-50">0</p>
           </div>
           <div class="d-flex flex-column justify-content-center">
            ...
            <p class="text-center text-green-100 fw-medium titre1 fs-3 mt-2"> VILLES</p>
            <p id="counter3" class="text-center display-3 fw-medium titre text-gray-50">0</p>
            </div>
